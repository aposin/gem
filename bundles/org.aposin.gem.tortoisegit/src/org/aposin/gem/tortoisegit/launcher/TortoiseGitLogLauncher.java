...
public class TortoiseGitLogLauncher extends AbstractNoParamsTortoiseGitLauncher {

    public static final String COMMAND_NAME = "log";

    public TortoiseGitLogLauncher(TortoiseLauncherProvider group, IWorktreeDefinition worktree) {
