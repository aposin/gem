 ...
 */
package org.aposin.gem.core.api.workflow.exception;
...
/**
 * Exception for {@link IRepositoryCommandBuilder} merge commands.
 */
public class MergeConflictException extends WorkflowException {
    private static final long serialVersionUID = 1L;

    public MergeConflictException(final String msg) {
        super(msg);
    }

    public MergeConflictException(final String msg, final Throwable cause) {
        super(msg, cause);
    }
}
